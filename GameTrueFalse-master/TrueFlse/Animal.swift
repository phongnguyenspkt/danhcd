...
//  TrueFalse
//
//  Created by Cong Danh on 12/23/16.
...
class Animal: UIViewController {
    ...
    func GoiY(){
        ...
        case 1:
            ...
            break
        case 2:
            self.Photo.image = UIImage(named: "meditate.JPG")
            lblGoiY.text = "maditate"
            
            CorrectAnswer = "1"
            break
        case 3:
            self.Photo.image = UIImage(named: "monument.JPG")
            lblGoiY.text = "monument"
        ...
        case 4:
            self.Photo.image = UIImage(named: "negative.JPG")
            lblGoiY.text = "negetive"
            
            
            CorrectAnswer = "1"
            break
        case 5:
            self.Photo.image = UIImage(named: "overkill.JPG")
            lblGoiY.text = "overkill"
            
            
            CorrectAnswer = "2"
            break
        case 6:
            self.Photo.image = UIImage(named: "pedigree.JPG")
            lblGoiY.text = "pedigree"
